...
class KeywordInMetaDescription extends Analysis {
	...
	newResult() {
		return new AnalysisResult()
			...
			.setEmpty( __( 'Add Focus Keyword to your SEO Meta Description.', 'rank-math' ) )
			.setTooltip( __( 'Make sure the focus keyword appears in the SEO description too.', 'rank-math' ) )
	}
	...
	getResult( paper, researcher ) {
		...
		const hasKeyword = includes( paper.getLower( 'description' ), normalizeQuotes( paper.getLower( 'keyword' ) ) )
	...
	translateScore( analysisResult ) {
		return analysisResult.hasScore() ?
			__( 'Focus Keyword used inside SEO Meta Description.', 'rank-math' ) :
			__( 'Focus Keyword not found in your SEO Meta Description.', 'rank-math' )
	}
}
