...
= 1.0.110 [Mar 08, 2023] =
- Improved: [Rank Math Analytics](https://rankmath.com/kb/analytics/) can now calculate the difference in ranking positions more accurately
- Fixed: Invalid secondary language post slug was showing in the [Site Analytics](https://rankmath.com/kb/analytics/#site-analytics) on some setups while using the Polylang plugin
- Fixed: [Table of Contents block](https://rankmath.com/kb/table-of-contents-block/) was showing the HTML tags used in the [FAQ block](https://rankmath.com/kb/faq-schema-block/) heading
- Fixed: HTML tags were included in the Anchor and ID generated by the Table of Contents block
- Removed: Deprecated `Attorney` Schema type from the [Business Type settings](https://rankmath.com/kb/local-seo/#business-type). Existing sites using this Business type will now be switched to `LegalService` as their LocalBusiness Schema type

= 1.0.110.1 [Mar 15, 2023] =
- Improved: Existing Yoast and AIO SEO Breadcrumbs shortcodes on the website will now output Rank Math's Breadcrumbs. Users no longer need to change them manually to [Rank Math's Breadcrumbs shortcode](https://rankmath.com/kb/breadcrumbs/#shortcode) after migration
