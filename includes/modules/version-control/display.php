...
require_once $directory . '/views/version-control-panel.php'; // phpcs:ignore WordPressVIPMinimum.Files.IncludingFile.UsingVariable
require_once $directory . '/views/beta-optin-panel.php'; // phpcs:ignore WordPressVIPMinimum.Files.IncludingFile.UsingVariable
require_once $directory . '/views/auto-update-panel.php'; // phpcs:ignore WordPressVIPMinimum.Files.IncludingFile.UsingVariable
