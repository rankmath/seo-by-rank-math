			...
			<div id="rank-math-pro-cta">
				<div className="rank-math-cta-table">
					...
					<div className="rank-math-cta-body">
						...
						<a href="https://rankmath.com/pro/?utm_source=Plugin&utm_medium=Overview%20Winning%20Posts&utm_campaign=WP" target="_blank" rel="noreferrer" className="button button-primary is-green">{ __( 'Upgrade', 'rank-math' ) }</a>
					</div>
				</div>
			</div>
		</Fragment>
