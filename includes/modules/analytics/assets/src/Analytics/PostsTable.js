		...
		<div className="rank-math-posts">
			<div id="rank-math-pro-cta" className="center">
				<div className="rank-math-cta-box blue-ticks top-20 width-50">
					...
					<a href="https://rankmath.com/pro/?utm_source=Plugin&utm_medium=Analytics%20Tab%20Table&utm_campaign=WP" target="_blank" rel="noreferrer" className="button button-primary is-green">{ __( 'Upgrade', 'rank-math' ) }</a>
				</div>
			</div>
			<TableCard
