				...
				foreach ( $this->modules as $module ) :
					...
					<div class="rank-math-box <?php echo $is_active ? 'active' : ''; ?> <?php echo $is_hidden ? 'hidden' : ''; ?> <?php echo $is_pro ? 'is-pro' : ''; ?>">
						...
						<header>
							<h3>
								...
								<?php if ( $is_upgradeable && ! defined( 'RANK_MATH_PRO_FILE' ) ) { ?>
									<span class="is-upgradeable rank-math-tooltip">
										<a href="https://rankmath.com/pricing/?utm_source=Plugin&utm_medium=<?php echo esc_attr( $module->get( 'title' ) ); ?> Module%20Upgradable%20Icon&utm_campaign=WP">
											<div>&#171;</div>
										</a>
							...
							<p><?php echo wp_kses_post( $module->get( 'desc' ) ); // phpcs:ignore ?></p>
						</header>
